...
class CategorySeeder extends Seeder
{
    public function run()
    {
        $categories = [
            ...
            ['id' => 176, 'name' => 'Category 176', 'slug' => 'category-176', 'icon' => null, 'image' => json_encode([]), 'details' => null, 'parent' => null, 'type_id' => 1, 'created_at' => now(), 'updated_at' => now(), 'deleted_at' => null            ],
            ['id' => 51, 'name' => 'Category 51', 'slug' => 'category-51', 'icon' => null, 'image' => json_encode([]), 'details' => null, 'parent' => null, 'type_id' => 1, 'created_at' => now(), 'updated_at' => now(), 'deleted_at' => null],
            ['id' => 54, 'name' => 'Category 54', 'slug' => 'category-54', 'icon' => null, 'image' => json_encode([]), 'details' => null, 'parent' => null, 'type_id' => 1, 'created_at' => now(), 'updated_at' => now(), 'deleted_at' => null],
            ['id' => 55, 'name' => 'Category 55', 'slug' => 'category-55', 'icon' => null, 'image' => json_encode([]), 'details' => null, 'parent' => null, 'type_id' => 1, 'created_at' => now(), 'updated_at' => now(), 'deleted_at' => null],
            ['id' => 58, 'name' => 'Category 58', 'slug' => 'category-58', 'icon' => null, 'image' => json_encode([]), 'details' => null, 'parent' => null, 'type_id' => 1, 'created_at' => now(), 'updated_at' => now(), 'deleted_at' => null],
            ['id' => 60, 'name' => 'Category 60', 'slug' => 'category-60', 'icon' => null, 'image' => json_encode([]), 'details' => null, 'parent' => null, 'type_id' => 1, 'created_at' => now(), 'updated_at' => now(), 'deleted_at' => null],
            ['id' => 69, 'name' => 'Category 69', 'slug' => 'category-69', 'icon' => null, 'image' => json_encode([]), 'details' => null, 'parent' => null, 'type_id' => 1, 'created_at' => now(), 'updated_at' => now(), 'deleted_at' => null],
            ['id' => 89, 'name' => 'Category 89', 'slug' => 'category-89', 'icon' => null, 'image' => json_encode([]), 'details' => null, 'parent' => null, 'type_id' => 1, 'created_at' => now(), 'updated_at' => now(), 'deleted_at' => null],
            ['id' => 102, 'name' => 'Category 102', 'slug' => 'category-102', 'icon' => null, 'image' => json_encode([]), 'details' => null, 'parent' => null, 'type_id' => 1, 'created_at' => now(), 'updated_at' => now(), 'deleted_at' => null],
            ['id' => 174, 'name' => 'Category 174', 'slug' => 'category-174', 'icon' => null, 'image' => json_encode([]), 'details' => null, 'parent' => null, 'type_id' => 1, 'created_at' => now(), 'updated_at' => now(), 'deleted_at' => null],
            ['id' => 175, 'name' => 'Category 175', 'slug' => 'category-175', 'icon' => null, 'image' => json_encode([]), 'details' => null, 'parent' => null, 'type_id' => 1, 'created_at' => now(), 'updated_at' => now(), 'deleted_at' => null]
        ];
